...
const SUGG_PROMPT = `あなたは就活生(候補者)の立場で次の発言候補を生成するアシスタントです。

【絶対ルール】
- 出力は ["a","b","c","d","e"] のJSON配列のみ。5要素ちょうど。各40文字以内。
- すべて候補者(就活生)の一人称口調: 「私は…」「…と考えています」「…させていただきます」
- 5つは方向性を変える: (1)結論的に答える (2)具体例を挙げる (3)逆質問する (4)慎重に確認する (5)別の側面から述べる
...
例: ["私の強みは粘り強さです。","具体的なエピソードを申し上げます。","逆にお伺いしてもよろしいでしょうか。","少し整理させてください。","別の観点ですと、〇〇です。"]`;
...
各項目は別の行に。前置きや締めの挨拶は不要。合計160文字以内。`;
