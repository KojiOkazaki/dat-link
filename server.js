...
const SUGG_PROMPT = `あなたは面接の候補者を支援するアシスタントです。直前のやり取りから、候補者が次に発言しそうな短いフレーズを必ず5つ、JSON配列のみで返してください。
- 各40文字以内
- 5つ互いに異なる方向性 (同意/具体例/質問返し/慎重/別角度 など)
- 前置き・説明・コードブロックは禁止
- 改行を含めない、必ず ["a","b","c","d","e"] の形式

例: ["はい、ありがとうございます。","具体例を挙げますと…","少し考えさせてください。","結論から申し上げます。","正直に申し上げると…"]`;
